...
namespace ERP.DatabaseAccessLayer.DB
{
    ...
    public partial class PRQ_ChemLocalPurcBillItem
    {
        public long BillItemID { get; set; }
        public Nullable<long> BillRefID { get; set; }
        ...
        public virtual PRQ_ChemLocalPurcBillRef PRQ_ChemLocalPurcBillRef { get; set; }

...
namespace ERP.DatabaseAccessLayer.DB
{
    ...
    public partial class INV_CrustLeatherReceiveColor
    {
        public long CLReceiveColorID { get; set; }
        public Nullable<long> CLReceiveItemID { get; set; }
        ...
        public Nullable<long> CrustLeatherIssueColorID { get; set; }
        ...
        public virtual INV_CrustLeatherIssueColor INV_CrustLeatherIssueColor { get; set; }
        public virtual INV_CrustLeatherReceive INV_CrustLeatherReceive { get; set; }
        public virtual Sys_Unit Sys_Unit { get; set; }
        public virtual INV_CrustLeatherReceiveItem INV_CrustLeatherReceiveItem { get; set; }

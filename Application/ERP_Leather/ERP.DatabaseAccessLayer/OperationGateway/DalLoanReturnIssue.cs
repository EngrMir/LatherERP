...
{
    public class DalLoanReturnIssue
    {
            ...
            try
            {
                using (var tx = new TransactionScope())
                {
                    using (_context)
                    {
                        ...
                        if (model.InvStoreTransItemList != null)
                        {
                            foreach (var chemicalItem in model.InvStoreTransItemList)
                            {
                                ...
                                else
                                {
                                    ...
                                    objStockDaily.Remark = "Loan Return Issue";
                                ...
                                if (!CheckSupplierStock)
                                {
                                    ...
                                    objStockSupplier.Remark = "Loan Return Issue";
                                ...
                                if (!CheckItemStock)
                                {
                                    ...
                                    objStockItem.Remark = "Loan Return Issue";
                        ...
                        curChemLocalPurcRecvPOEntity.RecordStatus = "RISU";

                        var curChemFrgnPurcOrdrEntity = _context.INV_TransRequest.First(m => m.RequestID == reqsId);
                        curChemFrgnPurcOrdrEntity.RecordStatus = "RISU";
        ...
        public INV_StoreTrans SetToModelObject(INVStoreTrans model, int userid)
        {
            ...
            Entity.TransactionCategory = "LRIS";//Loan Retun Issue
            Entity.TransactionType = "LRI";//Loan Retun Issue
            ...
            Entity.TransactionState = "FLRR";//Full Loan Retun Issue
        ...
        public INV_StoreTransItem SetToModelObject(INVStoreTransItem model, int userid)
        {
            ...
            Entity.RefTransactionQty = model.RefTransactionQty;
        ...
        public List<INVStoreTransRequest> GetLoanRequestInfoList()
        {
            List<INV_TransRequest> searchList = _context.INV_TransRequest.Where(m => m.RecordStatus == "CNF" && m.RequestType == "RLRR").OrderBy(m => m.RequestID).ToList();
        ...
        {
            //List<INV_StoreTrans> searchList = _context.INV_StoreTrans.OrderByDescending(m => m.TransactionID).ToList();
            //List<INV_StoreTrans> searchList = _context.INV_StoreTrans.Where(m => m.RecordStatus != "CNF").OrderByDescending(m => m.TransactionID).ToList();
            List<INV_StoreTrans> searchList = _context.INV_StoreTrans.Where(m => m.TransactionCategory == "LRIS" && m.TransactionType == "LRI").OrderByDescending(m => m.TransactionID).ToList();
        ...
        public INVStoreTransItem SetToBussinessObject(INV_TransRequestItem Entity)
        {
            ...
            Model.ItemID = Entity.RefItemID;
            Model.ChemicalName = Entity.RefItemID == null ? "" : _context.Sys_ChemicalItem.Where(m => m.ItemID == Entity.RefItemID).FirstOrDefault().ItemName;
            ...
            Model.RefPackSize = Entity.ReferencePackSize;
            Model.RefPackSizeName = Entity.ReferencePackSize == null ? "" : _context.Sys_Size.Where(m => m.SizeID == Entity.ReferencePackSize).FirstOrDefault().SizeName;
            Model.RefSizeUnit = Entity.ReferenceSizeUnit;
            Model.RefSizeUnitName = Entity.ReferenceSizeUnit == null ? "" : _context.Sys_Unit.Where(m => m.UnitID == Entity.ReferenceSizeUnit).FirstOrDefault().UnitName;
            ...
            //}
            Model.RefTransactionQty = Entity.ReturnValue;
        ...
        public INVStoreTrans SetToBussinessObject(INV_StoreTrans Entity)
        {
            ...
            else if (Entity.RecordStatus == "RISU")
        ...
        public INVStoreTransItem SetToBussinessObject(INV_StoreTransItem Entity)
        {
            ...
            Model.RefTransactionQty = Entity.RefTransactionQty; //Convert.ToInt32((Model.RefPackSizeName == null ? "0" : Model.RefPackSizeName)) * Entity.RefPackQty;
        ...
        public List<TransRequest> GetLoanReturnIssueRequestList()
        {
            List<INV_TransRequest> searchList = _context.INV_TransRequest.Where(m => m.RequestType == "RLRR" && m.RecordStatus == "CNF").OrderByDescending(m => m.RequestID).ToList();
        ...
        public List<INVStoreTransRequest> GetLoanRequestInfoList(string RequestID)
        {
            ...
            List<INV_TransRequest> searchList = _context.INV_TransRequest.Where(m => m.RequestID == reqsId).OrderBy(m => m.RequestID).ToList();
            return searchList.Select(c => SetToBussinessObject(c)).ToList<INVStoreTransRequest>();
        }
        ...
        public List<SysSupplier> GetSupplierSoruceList()
        {
            var query = @"select distinct cast(RequestTo as int) SupplierID,(select SupplierName from Sys_Supplier
                        ...
                        where FromSource = 'SUP' and RequestType='RLRR'";
